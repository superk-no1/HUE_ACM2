package club.superk.hueacm.backend.consumer;

import club.superk.hueacm.backend.consumer.utils.Game;
import club.superk.hueacm.backend.consumer.utils.JwtAuthentication;
...
public class WebSocketServer {
    ...
    // 维护一个线程安全的HashMap，将用户ID映射到WebSocket连接(所有实例都可访问)
    ...
    public static RecordMapper recodeMapper;
    ...
    @Autowired
    public void setRecodeMapper(RecordMapper recodeMapper) {
        WebSocketServer.recodeMapper = recodeMapper;
    }
    ...
    public static void startGame(Integer aId, Integer aBotId, Integer bId, Integer bBotId) {
        ...
        respB.put("opponent_photo", a.getAvatar());
