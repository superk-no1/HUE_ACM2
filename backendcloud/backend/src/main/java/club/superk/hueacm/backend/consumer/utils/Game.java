package club.superk.hueacm.backend.consumer.utils;
...
public class Game extends Thread {
    ...
    private final static String addBotUrl = "http://127.0.0.1:3002/botCode/add";
    ...
    private void saveToDatabase() {
        ...
        WebSocketServer.recodeMapper.insert(record);
    }
